  ...
  <section class="seccion contenedor-seccion">
    ...
    <form id="registro" class="registro" action="validar_registro.php" method="post">
      ...
      <div id="paquetes" class="paquetes seccion">
      ...
      <div id="resumen" class="resumen">
        ...
        <div class="caja">
          <div class="contenido-resumen">
            <div class="extras">
              <div class="orden">
                <label for="camisa_evento">Camisa del evento $10 <smaill>(promoción 7% dto.)</smaill></label>
                <input type="number" min="0" id="camisa_evento" name="pedido_camisas" size="3" placeholder="0">
              </div>
              <!--orden-->
              <div class="orden">
                <label for="etiquetas">Paquete de 10 etiquetas $2 <smaill>(HTML5, CSS3, Javascript, Chrome)</smaill>
                </label>
